...
# display plots
fig_sht.add_trace(go.Scatter(x=[0, 239], y=[sht_threshold, sht_threshold], name=' ', line=dict(dash='dash', color='#d3d3d3')))
...
fig_rh.add_trace(go.Scatter(x=[0, 239], y=[rh_threshold, rh_threshold], name=' ', line=dict(dash='dash', color='#d3d3d3')))
